---
title: Grade 8 역사 수업 미디어 자료
---

# 🎬 Grade 8 역사 수업 미디어 자료

미국 중학교 8학년(Grade 8) 미국사(U.S. History) 수업에서 활용되는 영상 자료 목록입니다. 학기 초에 배포되는 **[Visual Media Consent](https://docs.google.com/document/d/1C4YN9A6qJ0O5hMAUUCjIDqFF0BJZNdnWfarxsV48hh4/edit?tab=t.0)** 문서에 기재된 9가지 항목을 정리했습니다.

:::info Visual Media Consent란?
미국 학교에서는 수업 중 영화·다큐멘터리 등 영상 자료를 시청할 때 **학부모 동의서(Consent Form)** 를 받습니다. G 등급이 아닌 영화(PG 등)가 포함될 수 있어, 학부모가 각 자료의 내용을 미리 확인하고 서명하는 절차입니다. 동의하지 않을 경우 대체 과제가 제공됩니다.
:::
...
- **등급 확인**: *National Treasure*, *Remember the Titans*, *Hamilton* 은 **PG / PG-13** 등급입니다. 내용이 우려되면 동의하지 않을 수 있으며, 이 경우 대체 과제가 주어집니다.
- **가정 학습 활용**: 위 자료 대부분은 Disney+, Netflix, YouTube, PBS 웹사이트 등에서 시청할 수 있어 예습·복습용으로 활용하면 수업 이해도가 높아집니다.
- **영어 자막**: ESL 단계의 자녀라면 **영어 자막(English subtitle)** 을 켜고 보는 것이 청취와 어휘 학습에 함께 도움이 됩니다.
