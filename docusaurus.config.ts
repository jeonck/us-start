      ...
      items: [
        {
          ...
          items: [
            ...
            {href: 'https://jeonck.github.io/ai-agent/',          label: '🕹️ AI agent 실무'},
            ...
            {href: 'https://jeonck.github.io/k8s-adv/',            label: '⚓ Kubernetes 심화'},
            {href: 'https://jeonck.github.io/aws-sol-archi-prof/',  label: '☁️ AWS 솔루션 아키텍트'},
            {href: 'https://jeonck.github.io/terraform-onboard/',  label: '🏗️ Terraform IaC'},
            {href: 'https://jeonck.github.io/devops-professional/', label: '🚀 DevOps Professional'},
            {href: 'https://jeonck.github.io/jmeter-onboard/',     label: '📈 JMeter 성능 테스트'},
            {href: 'https://jeonck.github.io/isp-it-consulting/',   label: '📊 ISP & IT 컨설팅'},
          ],
        },
        {
          type: 'dropdown',
